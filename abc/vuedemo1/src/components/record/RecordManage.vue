...
export default {
  ...
  methods:{
    ...
    loadPost() {
      fetch("http://localhost:8090/record/listp?pageNum="+this.pageNum+"&pageSize=" + this.pageSize + "&name=" + this.name+
          "&goodstype="+this.goodstype.toString()+"&storage1="+this.storage.toString()+"&userId="+this.user.id.toString()+"&roleId="+
      this.user.roleId.toString())
