...
export default {
  ...
  methods:{
    ...
    del(id){
      console.log(id)
      this.$axios.get(this.$httpUrl+"/storage/deletebyid?id="+id
    ...
    loadPost1(){
      this.$axios.post(this.$httpUrl+"/storage/listp1",{
    ...
    loadPost() {
      fetch("http://localhost:8090/storage/listp?pageNum="+this.pageNum+"&pageSize=" + this.pageSize + "&name=" + this.name)
